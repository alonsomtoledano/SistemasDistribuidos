 ...
 implements MatriculasApp.MatriculasOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("matriculasDetectorOut", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // MatriculasApp/Matriculas/matriculasDetectorOut
       {
         String $result = null;
         $result = this.matriculasDetectorOut ();
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 2:  // MatriculasApp/Matriculas/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
