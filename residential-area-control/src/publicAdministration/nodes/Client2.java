...
public class Client2 {
	...
	static int clientPort = 4004;
	static String path = "./src/publicAdministration/logs/client2.log";
	...
	public static void addResident() {
		System.out.println("Add Resident Main");
		System.out.println("-------------------------------");
		String clientHost = "127.0.0.1";
	...
	public static void deleteResident() {
		System.out.println("Delete Resident Main");
		System.out.println("-------------------------------");
		String clientHost = "127.0.0.1";
	...
	public static void findSanctioned() {
		System.out.println("Find Sacntioned Main");
		System.out.println("-------------------------------");
		String clientHost = "127.0.0.1";
